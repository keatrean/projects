...
## Обо мне
Привет! Меня зовут Кузнецова Екатерина, я работаю в сфере Data Science. 
Этот репозиторий создан для демонстрации некоторых проектов, буду рада обратной связи или вопросам! 
